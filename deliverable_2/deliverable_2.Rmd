...
```{r, eval=TRUE}
demoCovid=merge(fromPy,covidData,by.x = "GEOID10",by.y = "ï..Location_Name")
demoCovid
```
```{r}
...
selection = createDataPartition(demoCovid$COMPOSITE_PERCENTILE,
                                p = 0.75,
                                list = FALSE)
#
trainGauss = demoCovid[ selection, ]

#
testGauss  = demoCovid[-selection, ]
```
